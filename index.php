  ...
  background: rgb(199, 190, 190);
    ...
    <div class="wrapper" id="wrapper">
        <nav class="navbar navbar-default navbar-static-top">
              <a class="navbar-brand" href="index.php">快来选出你心中的校花</a>
        </nav>
        <!-- ^ ?? -->
        ...
        <div class="progress-bar" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="">
          <span class="">0% Complete</span>
			...
			<?php include_once("DBMysql.php");
      $query=new DBMysql();$i=0;
      $sql="select * from stugirl order by rand() limit 2";
      $result=$query->query($sql);
      while($row=mysql_fetch_array($result)){ $i++;?>

			<div class="col_2 rankimg<?php echo $i; ?> rankimg">
				<input type="hidden" value="<?php echo $row["id"];?>">
				<a  href="#" id="ranka<?php echo $i; ?>">
          <img src="<?php echo $row["beauti"];?>" class="img-responsive img-rounded" alt="<?php echo $row["stu"];?> image"></a>
